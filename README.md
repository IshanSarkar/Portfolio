...
## Project 1: Retail Corporation Data Analysis (SQL - MySQL | Tableau)
### Business Problem:
...
## Project 6: Data Analysis of Electrical-Bike-Rental-Company (Python - numPy, pandas, matplotlib, seaborn, scipy.stats (ttest_ind, f_oneway, shapiro, levene, kruskal, chi2_contingency, pearsonr, spearmanr), statsmodels.graphics.gofplots - qqplot)
